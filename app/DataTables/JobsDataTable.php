...
class JobsDataTable extends DataTable
{
        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $btns = "<div class='btn-group mr-3 mb-4' role='group' aria-label='Basic example'>
                    <a href='" . route('jobs.edit', $query->id) . "' type='button' class='btn btn-primary'><i class='far fa-edit'></i></a>
                    <a href='" . route('jobs.destroy', $query->id) . "' type='button' class='btn btn-danger delete-item'><i class='fas fa-trash-alt'></i></a>
                </div>";
                return $btns;
            })
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('application_deadline'),
            Column::make('status'),
            Column::make('image'),
