                ...
                <div class="card-body">
                    <form action="{{ route('benefits.update', $benefit->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="mb-5">
                                    <label class="text-dark font-weight-medium" for="text">Text</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text mdi mdi-format-list-bulleted-type"
                                                id="basic-addon1"></span>
                                        </div>
                                        <textarea rows="5" class="form-control" name="text">{{ $benefit->text }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="mb-5">
                                    <label class="text-dark font-weight-medium" for="job">Job</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                        ...
                                        <select class="form-control" name="job">
                                            ...
                                            @foreach ($jobs as $job)
                                                <option
                                                    value="{{ $job->id }}"{{ $benefit->job->id === $job->id ? ' selected' : '' }}>
                                                    {{ $job->title }}
                                                </option>
                                            @endforeach
